...
?>
<head>
<link rel="stylesheet" href="/admin/pages/staff/styles.css">
</head>
<body>
    <main>
        <section class="add-account">
            <h2>Thêm nhân viên mới</h2>
            <form action="/admin/pages/staff/add.php" method="post">
                <div>
                    ...
                    if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            ...
                            echo "<tr>
                                ...
                                <td class='actions'>
                                    <a href='/admin/?page=editStaff&id=" . $row["id"] . "' class='edit-btn'>Sửa</a>
...
<script>
    function deleteSubmit(id) {
        if (confirm('Bạn có muốn xóa id [' + id + '] không?')) {
            window.location.href = '/admin/pages/staff/delete.php?id=' + id;
        }
    }
</script>
</html>
